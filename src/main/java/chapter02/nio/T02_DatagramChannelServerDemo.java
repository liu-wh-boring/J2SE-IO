...
public class T02_DatagramChannelServerDemo
{
	
    public static void main(String[] args) throws IOException 
    {
        new T02_DatagramChannelServerDemo().service();
    }
    ...
    public T02_DatagramChannelServerDemo() throws IOException 
    {
        try 
        {
    ...
    /*
     * 接收 用receive()读IO 作为服务端一般不需要调用connect()，
     * 如果未调用connect()时调用read()\write()读写，会报NotYetConnectedException
